...
namespace Juulsgaard.Spreadsheets.Reader;
...
public class SheetReaderService(ILogger<SheetReaderService> logger)
{
	...
	{
		var type = SheetReaderService.INPUT_TYPES.FindMatch(fileName, mimeType);
	...
	private static readonly FileTypeList<SheetFileTypes> INPUT_TYPES = [
		SheetReaderService.EXCEL_TYPE,
		SheetReaderService.CSV_TYPE,
		SheetReaderService.TSV_TYPE,
		SheetReaderService.TXT_TYPE
	];
}